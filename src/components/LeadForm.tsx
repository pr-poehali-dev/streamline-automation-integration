  ...
  if (status === "success") {
    return (
      <div className="bg-white border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-10 text-center">
        <div className="bg-[#16a34a] w-16 h-16 border-[3px] border-black flex items-center justify-center mx-auto mb-4">
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-8">
      ...
      <div className="space-y-4">
        ...
        {status === "error" && (
          <p className="text-[#16a34a] text-sm font-bold">Ошибка отправки. Попробуйте ещё раз.</p>
        )}

        <button
          type="submit"
          disabled={status === "loading"}
          className="w-full bg-[#16a34a] text-white py-4 border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all font-black text-lg disabled:opacity-60"
        >
